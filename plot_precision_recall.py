# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 23:00:34 2020
...
def plot_average_precision(Y_test, y_score, figname):
    ...
    plt.title('Average precision score, micro-averaged over all classes: AP={0:0.2f}'
              .format(average_precision["micro"]))
    plt.savefig('../result/' + figname + ' Average precision score, micro-averaged over all classes.png', dpi=300)
    ###############################################################################
    ...
    plt.savefig('../result/' + figname + ' Extension of Precision-Recall curve to multi-class.png', dpi=300)
    plt.show()