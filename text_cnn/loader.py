# -*- coding: utf-8 -*-
"""
Created on Tue Oct  6 22:23:16 2020
...
def build_vocab(vocab_dir,vocab_size=8000):
    """
    Args:
        filename:trian_filename,test_filename,val_filename
    ...
    """
    vocab_size=20000
    data = json.load(open("../wiki_word2content.json"))
    ...
    vocab_dir = config.vocab_filename
...
def process_file(labels,contents,word_to_id,cat_to_id,max_length=600):
    """
    Args:
